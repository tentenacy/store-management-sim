...
import com.tenutz.storemngsim.web.client.common.CommonGoogleOAuthClient;
...
@Slf4j
@Component(value = "kiosksimGoogleOAuthClient")
...
public class GoogleOAuthClient implements CommonGoogleOAuthClient {
    ...
    @Value("${kiosk-sim.social.google.client-id}")
    private String googleClientId;

    @Value("${kiosk-sim.social.google.client-secret}")
    private String googleClientSecret;

    @Value("${kiosk-sim.social.google.redirect}")
    private String googleRedirectUri;

    @Value("${kiosk-sim.social.google.url.login}")
    private String googleLoginUrl;

    @Value("${kiosk-sim.social.google.url.token}")
    private String googleTokenUrl;

    @Value("${kiosk-sim.social.google.url.profile}")
