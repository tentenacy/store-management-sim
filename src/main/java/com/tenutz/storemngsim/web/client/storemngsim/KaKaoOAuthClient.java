...
public class KaKaoOAuthClient implements CommonKaKaoOAuthClient {
    ...
    @Value("${store-mng-sim.social.kakao.client-id}")
    private String kakaoClientId;

    @Value("${store-mng-sim.social.kakao.redirect}")
    private String kakaoRedirectUri;

    @Value("${store-mng-sim.social.kakao.url.login}")
    private String kakaoLoginUrl;

    @Value("${store-mng-sim.social.kakao.url.token}")
    private String kakaoTokenUrl;

    @Value("${store-mng-sim.social.kakao.url.profile}")
