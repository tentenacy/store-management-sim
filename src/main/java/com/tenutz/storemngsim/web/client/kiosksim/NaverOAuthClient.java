...
@Component(value = "kiosksimNaverOAuthClient")
...
public class NaverOAuthClient implements CommonNaverOAuthClient {
    ...
    @Value("${kiosk-sim.social.naver.client-id}")
    private String naverClientId;

    @Value("${kiosk-sim.social.naver.client-secret}")
    private String naverClientSecret;

    @Value("${kiosk-sim.social.naver.redirect}")
    private String naverRedirectUri;

    @Value("${kiosk-sim.social.naver.url.login}")
    private String naverLoginUrl;

    @Value("${kiosk-sim.social.naver.url.token}")
    private String naverTokenUrl;

    @Value("${kiosk-sim.social.naver.url.profile}")
